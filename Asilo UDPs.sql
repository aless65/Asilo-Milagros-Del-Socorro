...
BEGIN
	BEGIN TRY
		IF NOT EXISTS (SELECT * FROM asil.tbEnfermedadesXResidente WHERE enfe_Id = @enfe_Id)
			...
			END
		ELSE
			SELECT 'La enfermedad no puede ser eliminada ya que est� siendo usada en otro registro'
	END TRY
	BEGIN CATCH
		SELECT 'Ha ocurrido un error'
	END CATCH
...
--************CATEGOR�AS HABITACIONES******************--

/*VISTA CATEGOR�AS HABITACIONES*/
...
/*LISTAR CATEGOR�AS HABITACIONES*/
...
/*INSERTAR CATEGOR�AS HABITACIONES*/
...
BEGIN
	BEGIN TRY
		IF NOT EXISTS (SELECT * FROM asil.tbCategoriasHabitaciones
			...
			SELECT 'La categoria de la habitaci�n ha sido insertada'
			END
		ELSE IF EXISTS (SELECT * FROM asil.tbCategoriasHabitaciones 
			...
			END
		ELSE
			SELECT 'Esta categoria de la habitaci�n ya existe'
	END TRY
	BEGIN CATCH
		SELECT 'Ha ocurrido un error'
	END CATCH
...
/*EDITAR CATEGOR�AS HABITACIONES*/
...
/*ELIMINAR CATEGOR�AS HABITACIONES*/
...
BEGIN
	...
	IF NOT EXISTS (SELECT * FROM asil.tbCategoriasHabitaciones WHERE cate_Id = @cate_Id AND cate_Estado = 1)
		...
		END
		ELSE
			SELECT 'La categoria no puede ser eliminado ya que est� siendo usado en otro registro'
	END TRY
	BEGIN CATCH
		SELECT 'Ha ocurrido un error'
	END CATCH
...
BEGIN
	BEGIN TRY
		IF NOT EXISTS (SELECT * FROM asil.tbInventarioPorCentro WHERE medi_Id = @medi_Id AND invecent_Stock > 0)
			...
			END
		ELSE
			SELECT 'El medicamento no puede ser eliminado ya que est� siendo usado en otro registro'
	END TRY
	BEGIN CATCH
		SELECT 'Ha ocurrido un error'
	END CATCH
...
BEGIN
	...
	BEGIN
		...
		END
		ELSE
			SELECT 'El cargo no puede ser eliminado ya que est� siendo usado en otro registro'
	END TRY
	BEGIN CATCH
		SELECT 'Ha ocurrido un error'
	END CATCH
...
BEGIN
	...
	IF NOT EXISTS (SELECT * FROM asil.tbResidentes WHERE diet_Id = @diet_Id AND resi_Estado = 1)
	 BEGIN
		...
		END
		ELSE
			SELECT 'La dieta no puede ser eliminada ya que est� siendo usado en otro registro'
	END TRY
	BEGIN CATCH
		SELECT 'Ha ocurrido un error'
	END CATCH
...
BEGIN
	BEGIN TRY
		IF NOT EXISTS (SELECT * FROM asil.tbEmpleados WHERE empe_Id = @empe_Id)
			...
			END
		ELSE
			SELECT 'El registro del empleado no se puede eliminar porque est� siendo usado'
	END TRY
	BEGIN CATCH
		SELECT 0
	END CATCH
...
BEGIN
	BEGIN TRY
		IF NOT EXISTS (SELECT * FROM asil.tbResidentes WHERE resi_Id = @resi_Id)
			...
			END
		ELSE
			SELECT 'El registro del Residente no puede ser eliminado porque est� siendo usado'
	END TRY
	BEGIN CATCH
		SELECT 0
	END CATCH
...
BEGIN
	...
	IF NOT EXISTS (SELECT * FROM asil.tbParentescos WHERE pare_Id = @pare_Id AND pare_Estado = 1)
		...
		END
		ELSE
			SELECT 'El parentesco no puede ser eliminado ya que est� siendo usado en otro registro'
...
BEGIN
	BEGIN TRY
		...
		ELSE IF EXISTS (SELECT * FROM asil.tbEncargados 
			...
			END
		ELSE
			SELECT 'Ya existe un encargado con este n�mero de identidad'
	END TRY
	BEGIN CATCH
		SELECT 'Ha ocurrido un error'
	END CATCH
...
BEGIN
	...
	IF NOT EXISTS (SELECT * FROM asil.tbTiposSangre WHERE tiposang_Id = @tiposang_Id AND tiposang_Estado = 1)
		...
		END
		ELSE
			SELECT 'El tipo de sangre no puede ser eliminado ya que est� siendo usado en otro registro'
	END TRY
	BEGIN CATCH
		SELECT 'Ha ocurrido un error'
	END CATCH
...
BEGIN
	...
	IF NOT EXISTS (SELECT * FROM asil.tbEnfermedadesXResidente WHERE enferesi_Id = @enferesi_Id AND enferesi_Estado = 1)
		...
		END
		ELSE
			SELECT 'La enfermedad no puede ser eliminada ya que est� siendo usado en otro registro'
	END TRY
	BEGIN CATCH
		SELECT 'Ha ocurrido un error'
	END CATCH
...
BEGIN
	BEGIN TRY
		IF NOT EXISTS (SELECT * FROM asil.VW_tbExpedientes WHERE expe_Id = @expe_Id AND resi_Estado = 1)
			...
			END
		ELSE
			SELECT 'El expediente no puede ser eliminado ya que est� siendo usado en otro registro'
	END TRY
	BEGIN CATCH
		SELECT 'Ha ocurrido un error'
	END CATCH
...
/*Listar historial expedientes seg�n expediente*/
...
BEGIN
	BEGIN TRY
		IF NOT EXISTS (SELECT * FROM asil.tbHabitaciones
			...
			SELECT 'La habitaci�n ha sido insertada'
			END
		ELSE IF EXISTS (SELECT * FROM asil.tbHabitaciones 
			...
			END
		ELSE
			SELECT 'Esta habitaci�n ya existe'
	END TRY
	BEGIN CATCH
		SELECT 'Ha ocurrido un error'
	END CATCH
...
BEGIN
	...
	IF NOT EXISTS (SELECT * FROM asil.tbHabitaciones 
		...
		BEGIN			
			...
			SELECT 'La habitaci�n ha sido editada'
		END
		ELSE IF EXISTS (SELECT * FROM asil.tbHabitaciones
						WHERE habi_Numero      = @habi_Numero
							  AND habi_Estado  = 1
			...
			SELECT 'La habitaci�n ya existe'
		ELSE
			UPDATE  asil.tbHabitaciones
			SET     habi_Estado	          = 1,
			        cate_Id = @cate_Id,
...
BEGIN
	...
	IF NOT EXISTS( SELECT * FROM asil.tbHabitacionesXResidente WHERE habi_Id = @habi_Id and habiresi_Estado = 1 )
	   BEGIN
		...
		SELECT 'La habitaci�n ha sido eliminada'
		END
		ELSE 
		SELECT 'La habitaci�n no puede ser eliminada ya que se esta usando en otro registro'
	END TRY
	BEGIN CATCH
		SELECT 'Ha ocurrido un error'
	END CATCH
...
AS
	SELECT t1.dona_Id,
		   ...
		   t1.[dona_QueEs],
			...
			WHEN [dona_QueEs] = 'I' THEN 'Instituci�n'
...
BEGIN
	BEGIN TRY
		UPDATE asil.tbDonaciones
			...
			SELECT 'La donaci�n ha sido editada exitosamente'
	END TRY
	BEGIN CATCH
		SELECT 'Ha ocurrido un error'
	END CATCH
...
BEGIN
	BEGIN TRY
		UPDATE asil.tbDonaciones
				...
				SELECT 'La donaci�n ha sido eliminada'
	END TRY
	BEGIN CATCH
		SELECT 'Ha ocurrido un error'
	END CATCH
...
/*ACTUALIZAR HISTORIAL PAGOS*/   /* HAY ALGO QUE NO ME CUADRA AQU�, PENDIENTE COMENTARLO CON ALLE*/
...
BEGIN
	BEGIN TRY
		IF NOT EXISTS (SELECT * FROM asil.tbCentros
			...
			SELECT 'El centro ha sido insertado con �xito'
			END
