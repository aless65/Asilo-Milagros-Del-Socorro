 ...
 */
  ...
  residenteActionFormatter(residente: Residente): any {
    return this.sanitizer.bypassSecurityTrustHtml(
      ` <a href="javascript:void(0);" class="edit action-icon" id="${residente.resi_Id}"> <i class="mdi mdi-square-edit-outline" style="color: #6658dd;"></i></a>
        <a href="javascript:void(0);" class="delete action-icon" id="${residente.resi_Id}"> <i class="mdi mdi-delete" style="color: #9f100e;"></i></a>`
    );
  }
