...
class Header {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "16.0.2", type: Header, selector: "p-header", ngImport: i0, template: '<ng-content></ng-content>', isInline: true });
}
...
class Footer {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "16.0.2", type: Footer, selector: "p-footer", ngImport: i0, template: '<ng-content></ng-content>', isInline: true });
}
...
class PrimeTemplate {
    ...
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "16.0.2", type: PrimeTemplate, selector: "[pTemplate]", inputs: { type: "type", name: ["pTemplate", "name"] }, ngImport: i0 });
}
...
class SharedModule {
    ...
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "16.0.2", ngImport: i0, type: SharedModule, declarations: [Header, Footer, PrimeTemplate], imports: [CommonModule], exports: [Header, Footer, PrimeTemplate] });
